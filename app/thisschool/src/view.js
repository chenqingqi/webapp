...
module('school_view',function()
{
    ...
    function ErgodicResourceslist(){
    	...
    	for(var i=0;i<qualityCourse.length;i++)
    	{
    		...
    		//uisearchui='<a id="link" href="/app/course/course.html?treeid='+qualityCourse[i].courseId+'&publicCourse='+qualityCourse[i].publicCourse+'"><div id="item_course_library"><img src="'+pic+'"><p id="title">'+qualityCourse[i].title+'</p><p id="school">'+qualityCourse[i].schoolName+'</p><p id="price" class="'+priceClass+'">'+price+'</p></div></a>'
			uisearchui='<a id="link" href="/app/course/course.html?treeid='+qualityCourse[i].courseId+'&publicCourse='+qualityCourse[i].publicCourse+'&type=0'+'"><div id="item_course_library"><img src="'+pic+'"><p id="title">'+qualityCourse[i].title+'</p><p id="school">'+qualityCourse[i].schoolName+'</p></div></a>'
			$('#scroller_school').append(uisearchui);
			var wrapperheight=($('body').height()-110)+'px';
    	}

...
module('search_view',function()
{
    ...
    function ErgodicResourceslist(){
    	...
    	for(var i=0;i<qualityCourse.length;i++)
    	{
    		...
    		uisearchui='<a href="/app/course/course.html?treeid='+qualityCourse[i].courseId+'&publicCourse='+qualityCourse[i].publicCourse+'" id="link"><div id="item_course_library"><img src="'+pic+'"><p id="title">'+qualityCourse[i].title+'</p><p id="school">'+qualityCourse[i].schoolName+'</p><p id="price" class="'+priceClass+'">'+price+'</p></div></a>'
